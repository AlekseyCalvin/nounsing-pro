...
// ============================================================================
// 3. RE-EXPORTS FROM VERSE-TSCRIPT RHYMER (Unified Package API)
// ============================================================================
export {
  RhymeType,
  SlantOptions,
  ...
  firstPhonesForWord,
  stressPattern,
  stressedVowelIndices,
  lastStressedVowelIndex,
  penultimateStressedVowelIndex,
  antepenultimateStressedVowelIndex,
  rhymingPartFromIndex,
  onsetBefore,
  codaAfter,
  structuralRhymeTypes,
  isMasculine,
  isFeminine,
  isDactylic,
  perfectRhyme,
  ...
  getRhymes,
  randomRhyme,
  filterByForbiddenRhymingParts,
  deduplicatePools,
  assonance,
  consonance,
  alliteration,
  rhymeSameStress,
  wildcardMixPhonesRegexSearches
